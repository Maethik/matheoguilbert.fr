...
<div>
	...
	<ProjectsColumns>
		...
		<div>
			...
			J'ai tout développé moi-même : l'application en tant que telle, la landing page, la gestion des licences logicielles, ainsi que la mise en place de l'architecture serveur qui accueille tout cela.
		</div>
	</ProjectsColumns>
</div>
